    ...
    bazmanal() {
        ...
        if (vandakZ) {
            for (var i in hreshArr) {
                if (vandakZ[0] == hreshArr[i].x && vandakZ[1] == hreshArr[i].y) {
                    var zuygiIndex = i;
                    break;
                }
            }
        ...
        if (zuygiIndex && this.bazmanaluAragutyun >= 3 && hreshArr[zuygiIndex].ser == this.zuyg) {
            var vandak = random(this.yntrelVandakTunavoreluHamar(0, 1, 2, 3));
            if (vandak) {
                var norHresh = new Hresh(vandak[0], vandak[1], 5);
                hreshArr.push(norHresh);
